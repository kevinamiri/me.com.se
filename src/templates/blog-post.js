...
const BlogPostTemplate = props => {
  ...
  const siteTags = props.data.site.siteMetadata.tags
  ...
  return (
    <Layout location={props.location} title={siteTitle} tags={siteTags}>
      <SEO
      ...
      <article>
        <header>
          ...
          <p className="text-sm leading-loose mb-8 ">{post.frontmatter.date}</p>
      ...
      <nav>
        <ul className="flex flex-wrap justify-between mb-8">
          ...
          <li>
            {next && (
              <Link className="text-blue-600" to={next.fields.slug} rel="next">
